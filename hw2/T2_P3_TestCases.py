...
def test_p3_softmax(vanilla_model, basis_model):
    vanilla_weights = np.array([[ 11.15986009,   3.11575821, -14.21347794],
       [  1.21220146,   0.64915409,   6.55810972],
       [-10.36110623,  -1.75395698,   9.66632353]])
    basis_weights = np.array([[-8.39777647,  6.79468901, -1.03230498],
       [-4.82820958,  4.30974603,  0.4994725 ],
       [15.23694137, -9.09347973,  2.54378779]])
