...
\duedate{11:59pm EST, March 23, 2022}
...
\footnotetext[1]{As an alternative to taking the integral, you may want to use
...
\footnotetext[2]{Consider a regularization term of
the form \(g(\theta) = - a \theta + b \theta^{2}\) and work
backwards from your derivations in 3.c. For the interpretation, try
completing the square and consider the prior mode,
i.e.~\(\arg \max_{\theta} p(\theta)\), which you derived in 3.b.}
